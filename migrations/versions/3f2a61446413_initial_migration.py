...
Revision ID: 3f2a61446413
Revises: None
Create Date: 2016-06-21 22:38:17.679000

"""

# revision identifiers, used by Alembic.
revision = '3f2a61446413'
down_revision = None
...
def upgrade():
    ...
    sa.Column('sharepoint_server_id', sa.Integer(), nullable=True),
    ...
    sa.ForeignKeyConstraint(['sharepoint_server_id'], ['sharepoint_server.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
